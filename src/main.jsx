...
{"name":"exact product name from label","brand":"brand/company from label","category":"Grains|Spices|Drinks|Dairy|Snacks|Vegetables|Fruits|Cleaning|Personal Care|Other","unit":"size like 200ml or 1kg","confidence":92,"description":"brief product description in English","price_range":"estimated retail price range in EUR","search_terms":["term1","term2","term3"]}`
          }
        }:{
          role:'user',
          content:`Product search query: "${query}". Respond ONLY with valid JSON (no markdown):
{"name":"most likely product name","brand":"common brand","category":"Grains|Spices|Drinks|Dairy|Snacks|Vegetables|Fruits|Cleaning|Personal Care|Other","unit":"typical unit","confidence":85,"description":"brief description","price_range":"estimated EUR price range","search_terms":["${query}","term2","term3"]}`
        }]
      })
    });
    const data=await resp.json();
